    ...
    <div class="content-wraper">
      <div class="content">
        ...
        <div class="operate-btns">
          <div class="btn-yellow" @click="login(loginParams.mobile)">登录<span class="login-right"></span></div>
        </div>
      </div>
    </div>
    <footer class="copyright-wrapper">
      <div>
        <span>Copyright©2018 智能云科信息科技有限公司 All Rights Reserved. 沪ICP备15045455号-1</span>
      </div>
    </footer>
  </section>
</template>
